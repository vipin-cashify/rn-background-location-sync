 ...
 * @internal
 */
export function toTrackingOptionsSpec(options) {
  if (!options) {
    return {};
  }
  return {
    ...
    activityType: options.activityType ? String(options.activityType) : undefined,
    waitForAccurateLocation: options.waitForAccurateLocation,
    foregroundOnly: options.foregroundOnly,
    distanceFilter: options.distanceFilter,
    notificationOptions: options.notificationOptions ? JSON.stringify(options.notificationOptions) : undefined
  };
}
//# sourceMappingURL=trackingOptionsMapper.js.map